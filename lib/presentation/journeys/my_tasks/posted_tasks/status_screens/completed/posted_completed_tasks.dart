...
class PostedCompletedTasks extends StatefulWidget {
  final EndTaskCubit endTaskCubit;

  const PostedCompletedTasks({Key? key, required this.endTaskCubit})
      : super(key: key);

  @override
  State<PostedCompletedTasks> createState() => _PostedCompletedTasksState();
}

class _PostedCompletedTasksState extends State<PostedCompletedTasks>
