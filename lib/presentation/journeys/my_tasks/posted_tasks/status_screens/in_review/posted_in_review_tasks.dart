...
import 'in_review_item.dart';

class PostedInReviewTasks extends StatefulWidget {
  final EndTaskCubit endTaskCubit;

  const PostedInReviewTasks({
    Key? key,
    required this.endTaskCubit,
  }) : super(key: key);

  @override
  State<PostedInReviewTasks> createState() => _PostedInReviewTasksState();
}

class _PostedInReviewTasksState extends State<PostedInReviewTasks>
