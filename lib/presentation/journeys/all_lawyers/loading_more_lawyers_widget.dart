...
class LoadingMoreLawyersWidget extends StatelessWidget {
  final FetchLawyersCubit fetchLawyersCubit;

  const LoadingMoreLawyersWidget({
    Key? key,
    required this.fetchLawyersCubit,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(
        child: BlocConsumer<FetchLawyersCubit, FetchLawyersState>(
          /// listener
