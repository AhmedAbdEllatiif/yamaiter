...
class TaskFormClient extends StatefulWidget {
  ...
  @override
  State<TaskFormClient> createState() => _TaskFormClientState();
}

class _TaskFormClientState extends State<TaskFormClient> {
  late final CreateTaskClientCubit _createTaskClientCubit;
  ...
  void initState() {
    ...
    _createTaskClientCubit =
        widget.createTaskClientCubit ?? getItInstance<CreateTaskClientCubit>();
  }

  @override
  void dispose() {
    if (widget.createTaskClientCubit == null) {
      _createTaskClientCubit.close();
    }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => _createTaskClientCubit,
      child: BlocListener<CreateTaskClientCubit, CreateTaskClientState>(
        bloc: _createTaskClientCubit,
        listener: (context, state) {
          //==> show snack bar with check internet connection
          if (state is ErrorWhileCreatingTaskClient) {
            ...
            child: Padding(
              ...
              child: BlocBuilder<CreateTaskClientCubit, CreateTaskClientState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is NotAcceptTermsToCreateTaskClient) {
                    return Center(
                  ...
                  if (state is UnAuthorizedCreateTaskClient) {
                    return Center(
                      child: AppErrorWidget(
                  ...
                  if (state is NotActivatedUserToCreateTaskClient) {
                    return Center(
                      child: AppErrorWidget(
  ...
  Widget _form(CreateTaskClientState state) {
    return Column(
  ...
  Widget _switchLoadingAndButton(CreateTaskClientState state) {
