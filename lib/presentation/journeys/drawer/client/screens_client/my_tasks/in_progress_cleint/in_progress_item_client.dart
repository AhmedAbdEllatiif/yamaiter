...
class InProgressTaskItemClient extends StatefulWidget {
  final TaskEntity taskEntity;

  const InProgressTaskItemClient({
    Key? key,
    required this.taskEntity,
  }) : super(key: key);

  @override
  State<InProgressTaskItemClient> createState() =>
      _InProgressTaskItemClientState();
}

class _InProgressTaskItemClientState extends State<InProgressTaskItemClient> {
  @override
