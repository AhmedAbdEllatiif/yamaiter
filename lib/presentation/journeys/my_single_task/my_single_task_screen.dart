...
import 'applicant_lawyers/list_of_applicant_lawyers.dart';

class MySingleTaskScreen extends StatefulWidget {
  final MySingleTaskArguments singleTaskParams;

  const MySingleTaskScreen({Key? key, required this.singleTaskParams})
      : super(key: key);

  @override
  State<MySingleTaskScreen> createState() => _MySingleTaskScreenState();
}

class _MySingleTaskScreenState extends State<MySingleTaskScreen> {
